...
class FedAVGAggregator(object):
    ...
    def aggregate(self, round_idx, total_round):
        ...
        print('Start KMeans, gradient list length:', len(gradient_list))
            ...
            for id in clas:
                if id %2 ==0:
                    if(id+1) not in clas :
                        ...
                        inCurrentGroup+=1
            Error[countt]= currentClassError+ max((inCurrentGroup-2)*2,0)
            countt+=1
...
'''
        ...
        wandb.log({"Round Error": tempIncorrect, "round": round_idx})
        ...
        result_file.write('Partition_1 Correct: ' + str(round_acc1 / 5) + ', Partition_2 Correct: ' + str(round_acc2 / 5) + ', Round Incorrect: ' + str(tempIncorrect / 10) + '\n')
