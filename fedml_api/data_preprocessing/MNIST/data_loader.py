...
def load_partition_data_mnist(batch_size,
    ...
    # print('data type:', type(train_data_local_dict[0][0][0]), len(train_data_local_dict[0][0][0]), train_data_local_dict[0][0][0])
    print(colorama.Fore.LIGHTGREEN_EX + "finish load_partition_data_mnist in data_loader.py" + colorama.Style.RESET_ALL)
    print(colorama.Fore.LIGHTGREEN_EX + 'Load data time cost: ' + str(time.time() - start) + ' seconds' + colorama.Style.RESET_ALL)
