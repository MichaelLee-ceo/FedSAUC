...
def load_partition_data_federated_emnist(dataset, data_dir, batch_size=DEFAULT_BATCH_SIZE):
    ...
    print(colorama.Fore.LIGHTGREEN_EX + "start load_partition_data_femnist in data_loader.py" + colorama.Style.RESET_ALL)
    ...
    print(colorama.Fore.LIGHTGREEN_EX + "finish load_partition_data_emnist in data_loader.py" + colorama.Style.RESET_ALL)
