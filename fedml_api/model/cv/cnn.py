...
class CNN_DropOut(torch.nn.Module):
    ...
    def __init__(self, only_digits=True):
        ...
        self.conv2d_1 = torch.nn.Conv2d(1, 8, kernel_size=3)     #16 * 26 * 26
        self.max_pooling = nn.MaxPool2d(2, stride=2)              #16 * 13 * 13
        self.conv2d_2 = torch.nn.Conv2d(8, 16, kernel_size=3)    #32 * 11 * 11
